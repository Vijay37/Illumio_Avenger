...
public class Illumio_Main {
	...
	public static void main(String[] args) {
		...
		Firewall fw = new Firewall("/Users/vijayaharshavardhanpalla/eclipse-workspace/Illumio_Firewall/src/com/Files/illumio_data.csv");  // Change the path of csv file as needed
		run_test_cases(fw); // Function to execute test cases
		
	}
	public static void run_test_cases(Firewall fw) {
		System.out.println("[3] Executing user defined test cases");
